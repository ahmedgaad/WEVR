...
class ChangeMobileSuccessfully extends StatelessWidget {
  const ChangeMobileSuccessfully({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            const SuccessScreen(
              ...
              subTitle:
                  'you have successfully change your mobile number. Please use your new mobile number when logging in',
            ),
            const Spacer(),
            defaultButton(
              function: () {
