        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(child: timeWidget(ColorManager.primary, '1:30 Pm')),
                  5.pw,
                  Expanded(
                      child: timeWidget(ColorManager.lightPrimary, '3:30 Pm')),
                  5.pw,
                  Expanded(
                      child: timeWidget(ColorManager.lightPrimary, '1:30 Pm')),
                  5.pw,
                  Expanded(child: timeWidget(ColorManager.lightGrey, '1:30 Pm')),
                  5.pw,
                  Expanded(child: timeWidget(ColorManager.lightGrey, '1:30 Pm')),
                  5.pw,
                  Expanded(
