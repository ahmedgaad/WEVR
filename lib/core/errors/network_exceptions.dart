...
abstract class NetworkExceptions with _$NetworkExceptions {
  ...
  static NetworkExceptions handleResponse(Response? response) {
    ...
    //TODO: how to customize error model to work with all error models
    List<RegisterModelError> listOfErrors = List.from(response?.data)
        .map((e) => RegisterModelError.fromJson(e))
        .toList();
    String allErrors = listOfErrors
        .map((e) => "${e.massage} : ${e.data?.email} ${e.data?.name} ${e.data?.phone} ${e.data?.password}")
        .toString()
        .replaceAll("(", "")
        .replaceAll(")", "");
